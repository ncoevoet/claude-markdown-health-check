...
`DESCRIPTION-TOO-LONG`, `DESCRIPTION-TRUNCATED`, `DESC-TOO-SHORT`, `OVER-500-LINES`,
`MISSING-TOC`,
`CHAINED-REF`, `NO-PROGRESSIVE-DISCLOSURE`, `THIRD-PERSON`,
`UNKNOWN-FRONTMATTER-FIELD`, `EMBEDDED-SECRET`, `UNFLAGGED-DESTRUCTIVE`,
`SETTINGS-BYPASS-MODE`, `SETTINGS-MCP-AUTOAPPROVE`, `SETTINGS-SANDBOX-OFF`,
`SETTINGS-AUTOMODE-BROAD`, `HOOK-HTTP-BLOCKED`, `CLAUDEMD-DEAD-SCRIPT`,
